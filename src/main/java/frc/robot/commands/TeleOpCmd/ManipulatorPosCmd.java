...
public class ManipulatorPosCmd extends CommandBase {
  ...
  public ManipulatorPosCmd(PIDElevatorSubsystem elevatorSubsystem, PIDArmSubsystem armSubsystem, IntakeSubsystem intakeSubsystem, Supplier<Boolean> IntakeEnabled, Supplier<Boolean> IntakeReverse, int kPosition) {
